...
if("TRUE" STREQUAL "TRUE")
  set(roboteq_diagnostics_SOURCE_PREFIX /home/turtle1/turtle_drive/src/roboteq/src/roboteq_diagnostics)
  set(roboteq_diagnostics_DEVEL_PREFIX /home/turtle1/turtle_drive/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roboteq_diagnostics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turtle1/turtle_drive/src/roboteq/src/roboteq_diagnostics/${idir}'.  ${_report}")
    endif()
