...
if("TRUE" STREQUAL "TRUE")
  ...
  set(roboteq_diagnostics_DEVEL_PREFIX /home/base/turtle_drive/devel)
  ...
  set(roboteq_diagnostics_INSTALL_PREFIX /home/base/turtle_drive/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roboteq_diagnostics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/base/turtle_drive/src/roboteq/roboteq_diagnostics/${idir}'.  ${_report}")
    endif()
