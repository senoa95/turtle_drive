...
if("TRUE" STREQUAL "TRUE")
  set(ps3joy_SOURCE_PREFIX /home/nishanth/TurtleStuff/turtle_drive/src/joystick_drivers/ps3joy)
  set(ps3joy_DEVEL_PREFIX /home/nishanth/TurtleStuff/turtle_drive/devel)
  set(ps3joy_INSTALL_PREFIX "")
  set(ps3joy_PREFIX ${ps3joy_DEVEL_PREFIX})
else()
  set(ps3joy_SOURCE_PREFIX "")
  set(ps3joy_DEVEL_PREFIX "")
  set(ps3joy_INSTALL_PREFIX /home/nishanth/TurtleStuff/turtle_drive/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ps3joy' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nishanth/TurtleStuff/turtle_drive/src/joystick_drivers/ps3joy/${idir}'.  ${_report}")
    endif()
