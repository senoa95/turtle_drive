...
if("TRUE" STREQUAL "TRUE")
  set(ar_track_alvar_msgs_SOURCE_PREFIX /home/turtle1/turtle_drive/src/ar_track_alvar/ar_track_alvar_msgs)
  set(ar_track_alvar_msgs_DEVEL_PREFIX /home/turtle1/turtle_drive/devel/.private/ar_track_alvar_msgs)
  ...
  set(ar_track_alvar_msgs_INSTALL_PREFIX /home/turtle1/turtle_drive/install)
...
if(NOT "/home/turtle1/turtle_drive/devel/.private/ar_track_alvar_msgs/include " STREQUAL " ")
  set(ar_track_alvar_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/turtle1/turtle_drive/devel/.private/ar_track_alvar_msgs/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ar_track_alvar_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turtle1/turtle_drive/src/ar_track_alvar/ar_track_alvar_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/turtle1/turtle_drive/devel/.private/ar_track_alvar_msgs/lib;/home/turtle1/turtle_drive/devel/lib;/opt/ros/kinetic/lib)
