...
if("TRUE" STREQUAL "TRUE")
  set(roboteq_diagnostics_SOURCE_PREFIX /home/sena/turtle_drive/src/roboteq/roboteq_diagnostics)
  set(roboteq_diagnostics_DEVEL_PREFIX /home/sena/turtle_drive/devel/.private/roboteq_diagnostics)
  ...
  set(roboteq_diagnostics_INSTALL_PREFIX /home/sena/turtle_drive/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roboteq_diagnostics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sena/turtle_drive/src/roboteq/roboteq_diagnostics/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sena/turtle_drive/devel/.private/roboteq_diagnostics/lib;/home/sena/turtle_drive/devel/lib;/opt/ros/kinetic/lib)
