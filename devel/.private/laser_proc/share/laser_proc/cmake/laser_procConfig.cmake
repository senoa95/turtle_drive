...
if("TRUE" STREQUAL "TRUE")
  set(laser_proc_SOURCE_PREFIX /home/trex/turtle_drive/src/laser_proc)
  set(laser_proc_DEVEL_PREFIX /home/trex/turtle_drive/devel/.private/laser_proc)
  ...
  set(laser_proc_INSTALL_PREFIX /home/trex/turtle_drive/install)
...
if(NOT "/home/trex/turtle_drive/src/laser_proc/include " STREQUAL " ")
  set(laser_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/trex/turtle_drive/src/laser_proc/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'laser_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/trex/turtle_drive/src/laser_proc/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/trex/turtle_drive/devel/.private/laser_proc/lib;/home/trex/turtle_drive/devel/lib;/home/trex/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
