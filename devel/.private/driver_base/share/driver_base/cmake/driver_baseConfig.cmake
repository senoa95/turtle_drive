...
if("TRUE" STREQUAL "TRUE")
  set(driver_base_SOURCE_PREFIX /home/trex/turtle_drive/src/driver_common/driver_base)
  set(driver_base_DEVEL_PREFIX /home/trex/turtle_drive/devel/.private/driver_base)
  ...
  set(driver_base_INSTALL_PREFIX /home/trex/turtle_drive/install)
...
if(NOT "/home/trex/turtle_drive/devel/.private/driver_base/include;/home/trex/turtle_drive/src/driver_common/driver_base/include;/usr/include " STREQUAL " ")
  set(driver_base_INCLUDE_DIRS "")
  set(_include_dirs "/home/trex/turtle_drive/devel/.private/driver_base/include;/home/trex/turtle_drive/src/driver_common/driver_base/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'driver_base' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/trex/turtle_drive/src/driver_common/driver_base/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/trex/turtle_drive/devel/.private/driver_base/lib;/home/trex/turtle_drive/devel/lib;/home/trex/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
