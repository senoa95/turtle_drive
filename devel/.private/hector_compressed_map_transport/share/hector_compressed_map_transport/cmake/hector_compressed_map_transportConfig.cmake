...
if("TRUE" STREQUAL "TRUE")
  set(hector_compressed_map_transport_SOURCE_PREFIX /home/turtle1/turtle_drive/src/hector_slam/hector_compressed_map_transport)
  set(hector_compressed_map_transport_DEVEL_PREFIX /home/turtle1/turtle_drive/devel/.private/hector_compressed_map_transport)
  ...
  set(hector_compressed_map_transport_INSTALL_PREFIX /home/turtle1/turtle_drive/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_compressed_map_transport' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turtle1/turtle_drive/src/hector_slam/hector_compressed_map_transport/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/turtle1/turtle_drive/devel/.private/hector_compressed_map_transport/lib;/home/turtle1/turtle_drive/devel/lib;/opt/ros/kinetic/lib)
