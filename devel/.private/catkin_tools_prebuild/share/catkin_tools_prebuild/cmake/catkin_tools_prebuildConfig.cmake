...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/trex/turtle_drive/build/catkin_tools_prebuild/${idir}'.  ${_report}")
    endif()
...
=======
    foreach(path /home/trex/turtle_drive/devel/.private/catkin_tools_prebuild/lib;/opt/ros/kinetic/lib)
