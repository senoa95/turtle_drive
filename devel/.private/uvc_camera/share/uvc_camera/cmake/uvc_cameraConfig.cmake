...
if("TRUE" STREQUAL "TRUE")
  ...
  set(uvc_camera_DEVEL_PREFIX /home/nishanth/TurtleStuff/turtle_drive/devel/.private/uvc_camera)
  ...
  set(uvc_camera_INSTALL_PREFIX /home/nishanth/TurtleStuff/turtle_drive/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'uvc_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nishanth/TurtleStuff/turtle_drive/src/camera_umd/uvc_camera/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nishanth/TurtleStuff/turtle_drive/devel/.private/uvc_camera/lib;/opt/ros/kinetic/lib;/home/nishanth/TurtleStuff/turtle_drive/devel/lib)
