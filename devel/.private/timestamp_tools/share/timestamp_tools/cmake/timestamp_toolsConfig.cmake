...
if("TRUE" STREQUAL "TRUE")
  set(timestamp_tools_SOURCE_PREFIX /home/sena/turtle_drive/src/driver_common/timestamp_tools)
  set(timestamp_tools_DEVEL_PREFIX /home/sena/turtle_drive/devel/.private/timestamp_tools)
  ...
  set(timestamp_tools_INSTALL_PREFIX /home/sena/turtle_drive/install)
...
if(NOT "/home/sena/turtle_drive/src/driver_common/timestamp_tools/include " STREQUAL " ")
  set(timestamp_tools_INCLUDE_DIRS "")
  set(_include_dirs "/home/sena/turtle_drive/src/driver_common/timestamp_tools/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'timestamp_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sena/turtle_drive/src/driver_common/timestamp_tools/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sena/turtle_drive/devel/.private/timestamp_tools/lib;/home/sena/turtle_drive/devel/lib;/opt/ros/kinetic/lib)
