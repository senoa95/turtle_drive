...
if("TRUE" STREQUAL "TRUE")
  set(hector_trajectory_server_SOURCE_PREFIX /home/turtle1/turtle_drive/src/hector_slam/hector_trajectory_server)
  set(hector_trajectory_server_DEVEL_PREFIX /home/turtle1/turtle_drive/devel/.private/hector_trajectory_server)
  ...
  set(hector_trajectory_server_INSTALL_PREFIX /home/turtle1/turtle_drive/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_trajectory_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turtle1/turtle_drive/src/hector_slam/hector_trajectory_server/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/turtle1/turtle_drive/devel/.private/hector_trajectory_server/lib;/home/turtle1/turtle_drive/devel/lib;/opt/ros/kinetic/lib)
