...
if("TRUE" STREQUAL "TRUE")
  set(rtk_SOURCE_PREFIX /home/trex/turtle_drive/src/rtk)
  set(rtk_DEVEL_PREFIX /home/trex/turtle_drive/devel/.private/rtk)
  set(rtk_INSTALL_PREFIX "")
  set(rtk_PREFIX ${rtk_DEVEL_PREFIX})
else()
  set(rtk_SOURCE_PREFIX "")
  set(rtk_DEVEL_PREFIX "")
  set(rtk_INSTALL_PREFIX /home/trex/turtle_drive/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rtk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/trex/turtle_drive/src/rtk/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/trex/turtle_drive/devel/.private/rtk/lib;/home/trex/turtle_drive/devel/lib;/home/trex/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
