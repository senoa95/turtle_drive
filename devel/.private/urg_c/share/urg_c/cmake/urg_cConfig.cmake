...
if("TRUE" STREQUAL "TRUE")
  set(urg_c_SOURCE_PREFIX /home/turtle1/turtle_drive/src/urg_c)
  set(urg_c_DEVEL_PREFIX /home/turtle1/turtle_drive/devel/.private/urg_c)
  set(urg_c_INSTALL_PREFIX "")
  set(urg_c_PREFIX ${urg_c_DEVEL_PREFIX})
else()
  set(urg_c_SOURCE_PREFIX "")
  set(urg_c_DEVEL_PREFIX "")
  set(urg_c_INSTALL_PREFIX /home/turtle1/turtle_drive/install)
...
if(NOT "/home/turtle1/turtle_drive/src/urg_c/current/include " STREQUAL " ")
  set(urg_c_INCLUDE_DIRS "")
  set(_include_dirs "/home/turtle1/turtle_drive/src/urg_c/current/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urg_c' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turtle1/turtle_drive/src/urg_c/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/turtle1/turtle_drive/devel/.private/urg_c/lib;/home/turtle1/turtle_drive/devel/lib;/opt/ros/kinetic/lib)
