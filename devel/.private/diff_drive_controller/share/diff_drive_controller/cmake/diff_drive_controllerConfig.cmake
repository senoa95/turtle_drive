...
if("TRUE" STREQUAL "TRUE")
  set(diff_drive_controller_SOURCE_PREFIX /home/trex/turtle_drive/src/ros_controllers/diff_drive_controller)
  set(diff_drive_controller_DEVEL_PREFIX /home/trex/turtle_drive/devel/.private/diff_drive_controller)
  ...
  set(diff_drive_controller_INSTALL_PREFIX /home/trex/turtle_drive/install)
...
if(NOT "/home/trex/turtle_drive/devel/.private/diff_drive_controller/include;/home/trex/turtle_drive/src/ros_controllers/diff_drive_controller/include " STREQUAL " ")
  set(diff_drive_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/trex/turtle_drive/devel/.private/diff_drive_controller/include;/home/trex/turtle_drive/src/ros_controllers/diff_drive_controller/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'diff_drive_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/trex/turtle_drive/src/ros_controllers/diff_drive_controller/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/trex/turtle_drive/devel/.private/diff_drive_controller/lib;/home/trex/turtle_drive/devel/lib;/home/trex/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
