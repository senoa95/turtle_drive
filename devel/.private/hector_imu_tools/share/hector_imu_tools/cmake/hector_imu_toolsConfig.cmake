...
if("TRUE" STREQUAL "TRUE")
  set(hector_imu_tools_SOURCE_PREFIX /home/turtle1/turtle_drive/src/hector_slam/hector_imu_tools)
  set(hector_imu_tools_DEVEL_PREFIX /home/turtle1/turtle_drive/devel/.private/hector_imu_tools)
  ...
  set(hector_imu_tools_INSTALL_PREFIX /home/turtle1/turtle_drive/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_imu_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turtle1/turtle_drive/src/hector_slam/hector_imu_tools/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/turtle1/turtle_drive/devel/.private/hector_imu_tools/lib;/home/turtle1/turtle_drive/devel/lib;/opt/ros/kinetic/lib)
