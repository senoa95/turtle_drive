...
set(MSG_I_FLAGS "-Idriver_base:/home/turtle1/turtle_drive/src/driver_common/driver_base/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/turtle1/turtle_drive/src/driver_common/driver_base/msg/SensorLevels.msg" NAME_WE)
add_custom_target(_driver_base_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "driver_base" "/home/turtle1/turtle_drive/src/driver_common/driver_base/msg/SensorLevels.msg" ""
)

get_filename_component(_filename "/home/turtle1/turtle_drive/src/driver_common/driver_base/msg/ConfigValue.msg" NAME_WE)
add_custom_target(_driver_base_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "driver_base" "/home/turtle1/turtle_drive/src/driver_common/driver_base/msg/ConfigValue.msg" ""
)

get_filename_component(_filename "/home/turtle1/turtle_drive/src/driver_common/driver_base/msg/ConfigString.msg" NAME_WE)
add_custom_target(_driver_base_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "driver_base" "/home/turtle1/turtle_drive/src/driver_common/driver_base/msg/ConfigString.msg" ""
)
