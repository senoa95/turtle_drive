...
echo_and_run /usr/bin/env \
    PYTHONPATH="/home/nishanth/TurtleStuff/turtle_drive/install/lib/python2.7/dist-packages:/home/nishanth/TurtleStuff/turtle_drive/build/rqt_joint_trajectory_controller/lib/python2.7/dist-packages:$PYTHONPATH" \
    CATKIN_BINARY_DIR="/home/nishanth/TurtleStuff/turtle_drive/build/rqt_joint_trajectory_controller" \
    "/usr/bin/python" \
    "/home/nishanth/TurtleStuff/turtle_drive/src/ros_controllers/rqt_joint_trajectory_controller/setup.py" \
    build --build-base "/home/nishanth/TurtleStuff/turtle_drive/build/rqt_joint_trajectory_controller" \
    install \
    $DESTDIR_ARG \
