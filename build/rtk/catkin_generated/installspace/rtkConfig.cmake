...
if("FALSE" STREQUAL "TRUE")
  set(rtk_SOURCE_PREFIX /home/base/turtle_drive/src/rtk)
  set(rtk_DEVEL_PREFIX /home/base/turtle_drive/devel)
  set(rtk_INSTALL_PREFIX "")
  set(rtk_PREFIX ${rtk_DEVEL_PREFIX})
else()
  set(rtk_SOURCE_PREFIX "")
  set(rtk_DEVEL_PREFIX "")
  set(rtk_INSTALL_PREFIX /home/base/turtle_drive/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rtk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/base/turtle_drive/install/${idir}'.  ${_report}")
    endif()
