...
if("FALSE" STREQUAL "TRUE")
  ...
  set(roboteq_msgs_DEVEL_PREFIX /home/base/turtle_drive/devel)
  ...
  set(roboteq_msgs_INSTALL_PREFIX /home/base/turtle_drive/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roboteq_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/base/turtle_drive/install/${idir}'.  ${_report}")
    endif()
