...
echo_and_run cd "/home/nishanth/TurtleStuff/turtle_drive/src/qt_ros/qt_create"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/nishanth/TurtleStuff/turtle_drive/src/qt_ros/qt_create/setup.py" \
    build --build-base "/home/nishanth/TurtleStuff/turtle_drive/build/qt_ros/qt_create" \
    install \
    $DESTDIR_ARG \
