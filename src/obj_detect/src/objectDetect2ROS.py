...
prototxt_path = os.path.join(rspkg.get_path('obj_detect'),"src","MobileNetSSD_deploy.prototxt.txt")
caffemodel_path = os.path.join(rspkg.get_path('obj_detect'),"src","MobileNetSSD_deploy.caffemodel")
