...
if("TRUE" STREQUAL "TRUE")
  set(roboteq_diagnostics_SOURCE_PREFIX /home/nishanth/TurtleStuff/turtle_drive/src/roboteq/roboteq_diagnostics)
  set(roboteq_diagnostics_DEVEL_PREFIX /home/nishanth/TurtleStuff/turtle_drive/devel_isolated/roboteq_diagnostics)
  ...
  set(roboteq_diagnostics_INSTALL_PREFIX /home/nishanth/TurtleStuff/turtle_drive/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roboteq_diagnostics' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nishanth/TurtleStuff/turtle_drive/src/roboteq/roboteq_diagnostics/${idir}'.  ${_report}")
    endif()
