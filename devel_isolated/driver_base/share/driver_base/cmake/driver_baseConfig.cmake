...
if("TRUE" STREQUAL "TRUE")
  set(driver_base_SOURCE_PREFIX /home/base/turtle_drive/src/driver_common/driver_base)
  set(driver_base_DEVEL_PREFIX /home/base/turtle_drive/devel_isolated/driver_base)
  ...
  set(driver_base_INSTALL_PREFIX /home/base/turtle_drive/install_isolated)
...
if(NOT "/home/base/turtle_drive/devel_isolated/driver_base/include;/home/base/turtle_drive/src/driver_common/driver_base/include;/usr/include " STREQUAL " ")
  set(driver_base_INCLUDE_DIRS "")
  set(_include_dirs "/home/base/turtle_drive/devel_isolated/driver_base/include;/home/base/turtle_drive/src/driver_common/driver_base/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'driver_base' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/base/turtle_drive/src/driver_common/driver_base/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/base/turtle_drive/devel_isolated/driver_base/lib;/opt/ros/kinetic/lib)
