...
if("TRUE" STREQUAL "TRUE")
  set(timestamp_tools_SOURCE_PREFIX /home/base/turtle_drive/src/driver_common/timestamp_tools)
  set(timestamp_tools_DEVEL_PREFIX /home/base/turtle_drive/devel_isolated/timestamp_tools)
  ...
  set(timestamp_tools_INSTALL_PREFIX /home/base/turtle_drive/install_isolated)
...
if(NOT "/home/base/turtle_drive/src/driver_common/timestamp_tools/include " STREQUAL " ")
  set(timestamp_tools_INCLUDE_DIRS "")
  set(_include_dirs "/home/base/turtle_drive/src/driver_common/timestamp_tools/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'timestamp_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/base/turtle_drive/src/driver_common/timestamp_tools/${idir}'.  ${_report}")
    endif()
