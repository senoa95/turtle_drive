...
if(NOT "/home/nishanth/TurtleStuff/turtle_drive/src/laser_proc/include " STREQUAL " ")
  set(laser_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/nishanth/TurtleStuff/turtle_drive/src/laser_proc/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'laser_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nishanth/TurtleStuff/turtle_drive/src/laser_proc/${idir}'.  ${_report}")
    endif()
