...
if("TRUE" STREQUAL "TRUE")
  set(laser_proc_SOURCE_PREFIX /home/base/turtle_drive/src/laser_proc)
  set(laser_proc_DEVEL_PREFIX /home/base/turtle_drive/devel_isolated/laser_proc)
  ...
  set(laser_proc_INSTALL_PREFIX /home/base/turtle_drive/install_isolated)
...
if(NOT "/home/base/turtle_drive/src/laser_proc/include " STREQUAL " ")
  set(laser_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/base/turtle_drive/src/laser_proc/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'laser_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/base/turtle_drive/src/laser_proc/${idir}'.  ${_report}")
    endif()
