...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_imu_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/base/turtle_drive/install_isolated/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/base/turtle_drive/install_isolated/lib;/home/base/turtle_drive/devel_isolated/hector_imu_attitude_to_tf/lib;/home/base/turtle_drive/devel_isolated/driver_common/lib;/home/base/turtle_drive/devel_isolated/driver_base/lib;/opt/ros/kinetic/lib)
