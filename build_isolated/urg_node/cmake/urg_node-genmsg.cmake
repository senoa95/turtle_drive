...
set(MSG_I_FLAGS "-Iurg_node:/home/base/turtle_drive/src/urg_node/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/base/turtle_drive/src/urg_node/msg/Status.msg" NAME_WE)
add_custom_target(_urg_node_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "urg_node" "/home/base/turtle_drive/src/urg_node/msg/Status.msg" ""
)
...
_generate_msg_cpp(urg_node
  "/home/base/turtle_drive/src/urg_node/msg/Status.msg"
  "${MSG_I_FLAGS}"
  ""
