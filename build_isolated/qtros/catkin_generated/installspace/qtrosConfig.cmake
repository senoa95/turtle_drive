...
if("FALSE" STREQUAL "TRUE")
  set(qtros_SOURCE_PREFIX /home/nishanth/TurtleStuff/turtle_drive/src/qtros)
  set(qtros_DEVEL_PREFIX /home/nishanth/TurtleStuff/turtle_drive/devel_isolated/qtros)
  set(qtros_INSTALL_PREFIX "")
  set(qtros_PREFIX ${qtros_DEVEL_PREFIX})
else()
  set(qtros_SOURCE_PREFIX "")
  set(qtros_DEVEL_PREFIX "")
  set(qtros_INSTALL_PREFIX /home/nishanth/TurtleStuff/turtle_drive/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Nishanth <Nishanth@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'qtros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nishanth/TurtleStuff/turtle_drive/install_isolated/${idir}'.  ${_report}")
    endif()
